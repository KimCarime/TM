...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE_TRUCKS="CREATE TABLE "+ TABLE_NAME_TRUCKS + " (" +
            ...
            COLUMN_NAME_REGISTRATION + " TEXT, "+
            COLUMN_NAME_T1 + "REAL, "+
            COLUMN_NAME_A11 + "REAL, "+
            COLUMN_NAME_A12 + "REAL, "+
            COLUMN_NAME_A13 + "REAL, "+
            COLUMN_NAME_MAGNETQUANTITY + " INTEGER, " +
            COLUMN_NAME_TIMEPUMP + " INTEGER, " +
            COLUMN_NAME_TIMEDELAYDRIVER + " INTEGER, " +
            COLUMN_NAME_PULSENUMBER + " INTEGER, " +
            COLUMN_NAME_FLOWMETERFREQUENCY + " INTEGER, " +
            COLUMN_NAME_COMMANDPUMP + " INTEGER, " +
            COLUMN_NAME_CALIBRATIONINPUTSENSORA + "REAL, "+
            COLUMN_NAME_CALIBRATIONINPUTSENSORB + "REAL, "+
            COLUMN_NAME_CALIBRATIONOUTPUTSENSORA + "REAL, "+
            COLUMN_NAME_CALIBRATIONOUTPUTSENSORB + "REAL, "+
            COLUMN_NAME_OPENINGTIMEEV1 + " INTEGER, " +
            COLUMN_NAME_OPENINGTIMEVA1 + " INTEGER, " +
            COLUMN_NAME_TOLERENCECOUNTING + " INTEGER, " +
            COLUMN_NAME_WAITINGDURATIONAFTERWATERADDITION + " INTEGER, " +
            COLUMN_NAME_MAX_DELAY_BEFORE_FLOWAGE + " INTEGER, " +
            COLUMN_NAME_MAXFLOWAGEERROR + " INTEGER, " +
            COLUMN_NAME_MAXCOUNTINGERROR + " INTEGER); ";
